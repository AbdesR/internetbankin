                                        ...
                                        <div class="col-12 table-responsive">
                                            <table class="table table-hover table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><?php echo $deposit; ?> DHs</td>
                                                        <td><?php echo $withdrawal; ?> DHs</td>
                                                        <td><?php echo $Transfer; ?> DHs</td>
                                                        <td><?php echo $money_in; ?> DHs</td>
                                                    </tr>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $rate_amt; ?> DHs</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Total Balance:</th>
                                                        <td><?php echo $totalMoney; ?> DHs</td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
