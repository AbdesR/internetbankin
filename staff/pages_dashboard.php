            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><?php echo $iB_withdrawal; ?> DHs</span>
                </div>
              </div>
            </div>
            <!-- Withdrawals-->
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><?php echo $iB_Transfers; ?> DHs</span>
                </div>
              </div>
            </div>
            <!-- /.Transfers-->
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><?php echo $TotalBalInAccount; ?> DHs</span>
                </div>
              </div>
            </div>
            <!-- ./Balances-->
                  ...
                  <div class="row">
                    <div class="col-sm-3 col-6">
                      <div class="description-block border-right">
                        <h5 class="description-header"><?php echo $iB_deposits; ?> DHs</h5>
                    ...
                    <div class="col-sm-3 col-6">
                      <div class="description-block border-right">
                        <h5 class="description-header"><?php echo $iB_withdrawal; ?> DHs</h5>
                    ...
                    <div class="col-sm-3 col-6">
                      <div class="description-block border-right">
                        <h5 class="description-header"><?php echo $iB_Transfers; ?> DHs</h5>
                    ...
                    <div class="col-sm-3 col-6">
                      <div class="description-block">
                        <h5 class="description-header"><?php echo $TotalBalInAccount; ?> DHs</h5>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php echo $row->transaction_amt; ?> DHs</td>
